...
describe('what survives a shared plan', () => {
  ...
  it('clamps a hand-edited warm-up count instead of showing it verbatim', () => {
    const bundle = { smitrix_plan: 1, name: 'x', routines: [{ id: 'r', name: 'R', ex: [{ id: '0025', sets: 3, reps: 5, warmupSets: 999 }] }], week: {}, customEx: [] }
  ...
  it('normalises a hand-edited rest to a positive whole number or drops it', () => {
    const withRest = restSec => ({ smitrix_plan: 1, name: 'x', routines: [{ id: 'r', name: 'R', ex: [{ id: '0025', sets: 3, reps: 5, restSec }] }], week: {}, customEx: [] })
  ...
  it('clamps out-of-range intensifier numbers to the floors the app enforces', () => {
    const bundle = { smitrix_plan: 1, name: 'x', routines: [{ id: 'r', name: 'R', ex: [{ id: '0025', sets: 3, reps: 5, intensifier: { type: 'dropset', count: 0, pct: -5 } }] }], week: {}, customEx: [] }
  ...
  it('falls back to the default drop percentage when the file omits it', () => {
    const bundle = { smitrix_plan: 1, name: 'x', routines: [{ id: 'r', name: 'R', ex: [{ id: '0025', sets: 3, reps: 5, intensifier: { type: 'dropset' } }] }], week: {}, customEx: [] }
