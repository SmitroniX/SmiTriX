...
- 🔄 **In-app update.** Settings → Data shows "SmiTriX vX available" when a newer release exists; one
...
- 📱 **"Use my self-hosted SmiTriX" works on a paired phone.** The phone app never fetched the
...
- 🌐 **smitrix.duarte-santos.ch has been rebuilt** — a bento layout with real device frames, a
...
If you run SmiTriX for other people, you have had no way to answer "who signed in, and when?" —
...
And the project has a working home again: SmiTriX now lives on **GitLab**, where CI builds the
...
- ▶️ **<https://smitrix.duarte-santos.ch/demo/>** — the in-browser demo, running on the project's
...
### SmiTriX moved to GitLab

- 🏠 **<https://gitlab.com/DuarteSantos8/smitrix>** is the home of the project. Same history,
...
- 🐳 **Prebuilt images are back.** `docker compose pull` now fetches
  `registry.gitlab.com/duartesantos8/smitrix/api` and `/web`, built for **amd64 and arm64** on
...
- 🌐 The in-browser demo also builds to GitLab Pages
  (<https://smitrix-bc111a.gitlab.io/>, which <https://duartesantos8.gitlab.io/smitrix/>
  redirects to); <https://smitrix.duarte-santos.ch/demo/> remains the copy the landing page
  embeds.
...
A housekeeping release, and two things worth reading even if you skip the rest. SmiTriX has moved
...
- 🏠 **SmiTriX now lives at <https://gitea.com/DuarteSantos/SmiTriX>.** The GitHub account
  was suspended on 2026-08-19 and took the repository, the GHCR images, the Pages demo and
  Discussions with it. `docker compose` now pulls `gitea.com/duartesantos/smitrix-{api,web}`; the
...
- ⚖️ **SmiTriX described the exercise dataset as "CC". That was wrong**, and it is now
...
- **Nothing changes for using SmiTriX.** It never shipped that media — not in the repository,
...
- **It does change what you may do with the media.** Reusing the images or animations — in
  SmiTriX or anywhere else, commercially or not — needs your own licence from Gym visual. See
  [NOTICE.md](NOTICE.md).
...
- 📊 **<https://smitrix.duarte-santos.ch> now runs self-hosted, cookieless
...
- 🔒 **Your instance does not.** The frontend only gets an analytics tag when
  ...
  image or in a plain `npm run build`. A self-hosted SmiTriX remains telemetry-free, as advertised.
...
- **A per-muscle exercise breakdown** behind the muscle card — estimated 1RM per exercise, decay
  ...
  [#92](https://github.com/DuarteSantos8/SmiTriX/pull/92),
  [#93](https://github.com/DuarteSantos8/SmiTriX/pull/93) and
  [#94](https://github.com/DuarteSantos8/SmiTriX/pull/94).
- **Fatigue is now intensity-weighted**, not volume alone: a set counts for more the closer it is
  ...
  [#55](https://github.com/DuarteSantos8/SmiTriX/pull/55).
...
- 🔗 **Supersets advance properly.** Completing a set moves to the next member of the group, the
  ...
  [#80](https://github.com/DuarteSantos8/SmiTriX/pull/80).
- ➖ **Remove an exercise from a running session**, with a superset-aware picker and a confirmation.
  ...
  [#83](https://github.com/DuarteSantos8/SmiTriX/pull/83).
- ⬅️ **The Android back button closes the open sheet** instead of leaving the screen or the app
  ...
  Contributed by [@Space-Hermes](https://github.com/Space-Hermes) in
  [#85](https://github.com/DuarteSantos8/SmiTriX/pull/85).
...
- 🐳 **The API service no longer has to be called `api`** ([#99]). The web image builds its nginx
  ...
  [@GAS85](https://github.com/GAS85) in [#100](https://github.com/DuarteSantos8/SmiTriX/pull/100).
...
- 🏷️ **Health checks and OCI image labels** on both images — source, licence, version, revision and
  ...
  [@GAS85](https://github.com/GAS85) in [#98](https://github.com/DuarteSantos8/SmiTriX/pull/98).
...
[#63]: https://github.com/DuarteSantos8/SmiTriX/issues/63
[#87]: https://github.com/DuarteSantos8/SmiTriX/issues/87
[#99]: https://github.com/DuarteSantos8/SmiTriX/issues/99
...
Contributed by [@Space-Hermes](https://github.com/Space-Hermes) in
[#50](https://github.com/DuarteSantos8/SmiTriX/pull/50).
...
Contributed by [@Space-Hermes](https://github.com/Space-Hermes) in
[#64](https://github.com/DuarteSantos8/SmiTriX/pull/64).
...
Contributed by [@Space-Hermes](https://github.com/Space-Hermes) in
[#67](https://github.com/DuarteSantos8/SmiTriX/pull/67).
...
- 📥 **Imports mapped more of what other apps export** ([#74]). Treadmill, Goblet Squat, Cycling and
  ...
  overlap could reach the names SmiTriX stores them under. Those and their neighbours are now in
...
[#79]: https://github.com/DuarteSantos8/SmiTriX/issues/79
[#74]: https://github.com/DuarteSantos8/SmiTriX/issues/74
[#60]: https://github.com/DuarteSantos8/SmiTriX/pull/60
...
SmiTriX written by someone other than me. Thank you.
...
SmiTriX is also a standalone mobile app — and it ships as a direct APK download, not
through app stores.

- 📱 **Standalone mobile app.** The same frontend now also builds as a native iPhone /
  Android app (Capacitor) — the install-and-done flavor of SmiTriX: no account, no server,
...
- 🤖 **Android APK, no Play Store.** The official build is a signed, sideloadable APK
  (~4.5 MB) from [smitrix.duarte-santos.ch](https://smitrix.duarte-santos.ch) — deliberately
...
- ▶️ **Live demo** at [duartesantos8.github.io/SmiTriX](https://duartesantos8.github.io/SmiTriX/) —
...
- 🐳 Prebuilt Docker images published to `ghcr.io/duartesantos8/smitrix-{api,web}` (amd64 + arm64)
